...
public class EnvironmentGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Period (seconds)");

        jLabelPeriod.setText("5");

        jLabelGameOver.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelGameOver.setForeground(new java.awt.Color(255, 0, 51));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabelPeriod, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jButtonStart, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabelGameOver, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jSlider1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSlider1StateChanged
        this.jLabelPeriod.setText("" + jSlider1.getValue()/1000);
        ...
        for (int x = 0; x < 15; x++) {
            for (int y = 0; y < 15; y++) {
                if (!myEnvironment[x][y].isCow() && !myEnvironment[x][y].isWolf() && !myEnvironment[x][y].isObstacle()) {
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("Images/Ground" + myEnvironment[x][y].getGress() + ".png"));
                }else if(myEnvironment[x][y].isObstacle()){
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("Images/Obstacle.png"));
                }else if(myEnvironment[x][y].isWolf()){
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("Images/Wolf.png"));
                }else if(myEnvironment[x][y].isCow()){
                    myPositions.get(new GUIPosition(x, y)).setIcon(new ImageIcon("Images/Cow.png"));
                }
            }
        }
    }
